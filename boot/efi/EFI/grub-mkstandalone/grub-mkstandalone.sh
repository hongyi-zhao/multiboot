...
werner@kubuntu:/mnt/sda2$ sudo grub-mkstandalone -O x86_64-efi -o grub-mkstandalone-x86_64.efi --modules='fat part_msdos part_gpt ext2 regexp iso9660 loopback chain search search_fs_uuid configfile'  boot/grub/grub.cfg=./grub-mkstandalone.cfg
