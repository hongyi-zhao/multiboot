...
grub-mkstandalone -O x86_64-efi -o grubx64.efi --modules='fat part_msdos part_gpt ext2 probe regexp search configfile' boot/grub/grub.cfg=./grub-mkstandalone.cfg
